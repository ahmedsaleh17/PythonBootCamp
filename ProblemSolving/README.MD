...
![another one](images/another%20one.png)
...
What if the last digit is not 9? In that case, all we need to do is add 1 to the last digit and return the updated array.

[Another One Solution](10.py)
---

# Problem 11: Weakest Strong Link
...
Explanation:
7 is the weakest in its row [7, 8, 9] 
and the strongest in its column [1, 4, 7], making it the Weakest Strong Link.

![alt text](images/weakstronglink.png)
...
[Weakest strong link solution](11.py)
---